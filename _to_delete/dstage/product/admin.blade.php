...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .navgrp{font-size:9.5px;letter-spacing:1.8px;color:#5E858C;font-weight:800;margin:15px 12px 5px}
  .nav{display:flex;align-items:center;gap:10px;padding:9px 12px;border-radius:9px;color:#A9CBD1;font-size:13px;
